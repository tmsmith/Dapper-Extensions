    ...
    public class SqlGeneratorFixture
    {
        ...
        public class SelectMethod : SqlGeneratorFixtureBase
        {
            ...
            public void WithSort_GeneratesSql()
            {
                ...
                Generator.Setup(g => g.GetTableName(ClassMap.Object)).Returns("TableName").Verifiable();
                Generator.Setup(g => g.BuildSelectColumns(ClassMap.Object)).Returns("Columns").Verifiable();
                Generator.Setup(g => g.GetColumnName(ClassMap.Object, "SortProperty", false))
                    .Returns("SortColumn")
                    .Verifiable();
        ...
        public class SelectPagedMethod : SqlGeneratorFixtureBase
        {
            ...
            public void WithSort_GeneratesSql()
            {
                ...
                Dialect.Setup(
                    d => d.GetPagingSql("SELECT Columns FROM TableName ORDER BY SortColumn ASC", 2, 10, parameters))
                    .Returns("PagedSQL")
                    .Verifiable();
            ...
            public void WithPredicateAndSort_GeneratesSql()
            {
                ...
                Dialect.Setup(
                    d =>
                        d.GetPagingSql("SELECT Columns FROM TableName WHERE PredicateWhere ORDER BY SortColumn ASC", 2,
                            10, parameters)).Returns("PagedSQL").Verifiable();
        ...
        [TestFixture]
        public class SelectTopMethod : SqlGeneratorFixtureBase
        {
            [Test]
            public void WithNullParameters_ThrowsException()
            {
            ...
            public class SelectSetMethod : SqlGeneratorFixtureBase
            {
                ...
                public void WithNoSort_ThrowsException()
                {
                    var ex = Assert.Throws<ArgumentNullException>(
                        () =>
                            Generator.Object.SelectSet(ClassMap.Object, null, null, 0, 1,
                                new Dictionary<string, object>()));
                    StringAssert.Contains("null or empty", ex.Message);
                }
                ...
                public void WithSort_GeneratesSql()
                {
                    ...
                    Dialect.Setup(
                        d => d.GetSetSql("SELECT Columns FROM TableName ORDER BY SortColumn ASC", 2, 10, parameters))
                        .Returns("PagedSQL")
                        .Verifiable();
                ...
                public void WithPredicateAndSort_GeneratesSql()
                {
                    ...
                    Dialect.Setup(
                        d =>
                            d.GetSetSql("SELECT Columns FROM TableName WHERE PredicateWhere ORDER BY SortColumn ASC", 2,
                                10, parameters)).Returns("PagedSQL").Verifiable();
            ...
            public class InsertMethod : SqlGeneratorFixtureBase
            {
                ...
                public void DoesNotGenerateIdentityColumns()
                {
                    ...
                    Generator.Setup(g => g.GetColumnName(ClassMap.Object, property2.Object, false))
                        .Returns("Column")
                        .Verifiable();
                    Generator.Setup(g => g.GetTableName(ClassMap.Object)).Returns("TableName").Verifiable();
                ...
                public void WithNoMappedColumns_Throws_Exception()
                {
                    ...
                    var ex =
                        Assert.Throws<ArgumentException>(
                            () => Generator.Object.Update(ClassMap.Object, predicate.Object, parameters));
            ...
            public class GetTableNameMethod : SqlGeneratorFixtureBase
            {
                ...
                public void CallsDialect()
                {
                    ...
                    Dialect.Setup(d => d.GetTableName("SchemaName", "TableName", null))
                        .Returns("FullTableName")
                        .Verifiable();
            ...
            public class GetColumnNameMethod : SqlGeneratorFixtureBase
            {
                ...
                public void DoesNotIncludeAliasWhenParameterIsFalse()
                {
                    ...
                    Generator.Setup(g => g.GetTableName(ClassMap.Object)).Returns("TableName").Verifiable();
                    Dialect.Setup(d => d.GetColumnName("TableName", "Column", null))
                        .Returns("FullColumnName")
                        .Verifiable();
                ...
                public void IncludesAliasWhenColumnAndNameAreDifferent()
                {
                    ...
                    Generator.Setup(g => g.GetTableName(ClassMap.Object)).Returns("TableName").Verifiable();
                    Dialect.Setup(d => d.GetColumnName("TableName", "Column", "Name"))
                        .Returns("FullColumnName")
                        .Verifiable();
                    var result = Generator.Object.GetColumnName(ClassMap.Object, property.Object, true);
                    Assert.AreEqual("FullColumnName", result);
            ...
            public class GetColumnNameUsingStirngMethod : SqlGeneratorFixtureBase
            {
                ...
                public void ThrowsExceptionWhenDoesNotFindProperty()
                {
                    ...
                    var ex =
                        Assert.Throws<ArgumentException>(
                            () => Generator.Object.GetColumnName(ClassMap.Object, "property", true));
                ...
                public void CallsGetColumnNameWithProperty()
                {
                    ...
                    Generator.Setup(g => g.GetColumnName(ClassMap.Object, property.Object, true))
                        .Returns("ColumnName")
                        .Verifiable();
            ...
            public class BuildSelectColumnsMethod : SqlGeneratorFixtureBase
            {
                ...
                public void GeneratesSql()
                {
                    ...
                    Generator.Setup(g => g.GetColumnName(ClassMap.Object, property1.Object, true))
                        .Returns("Column1")
                        .Verifiable();
                    Generator.Setup(g => g.GetColumnName(ClassMap.Object, property2.Object, true))
                        .Returns("Column2")
                        .Verifiable();
                    ClassMap.SetupGet(c => c.Properties).Returns(properties).Verifiable();
