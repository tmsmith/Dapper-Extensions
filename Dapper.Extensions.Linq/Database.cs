...
namespace Dapper.Extensions.Linq
{
    public class Database : IDatabase
    {
        ...
        public IMultipleResultReader GetMultiple(IGetMultiplePredicate predicate, IDbTransaction transaction, int? commandTimeout)
        {
            return _dapper.GetMultiple(Connection, predicate, transaction, commandTimeout);
        }

        public IMultipleResultReader GetMultiple(IGetMultiplePredicate predicate, int? commandTimeout)
        {
